...
//cardType:DC->储蓄卡,CC->信用卡
    ...
    bankMessage.prototype.constructor = bankMessage;
    bankMessage.prototype.init = function () {
        var _this = this;
        _this.message = bankCardAttribution(_this.options.cardNo);
    };
    bank.checked = function (options) {
        return new bankMessage(options);
    };
